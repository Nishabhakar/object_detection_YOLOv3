...
img_names = [r'dog.png', r'office.png']
...
class_names = load_class_names(r'/Users/nishabhakar/Downloads/coco.names')
...
assign_ops = load_weights(model_vars, r'/Users/nishabhakar/Downloads/yolov3.weights')
